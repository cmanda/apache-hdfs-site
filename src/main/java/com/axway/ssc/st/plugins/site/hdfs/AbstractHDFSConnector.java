...
public abstract class AbstractHDFSConnector implements HDFSConnector {
	...
	private HDFSBean mHdfsConfiguration;

	/** The ProxyService reference. */
	private ProxyService mProxyService;

	public AbstractHDFSConnector(HDFSBean config) {
		mHdfsConfiguration = config;
	}
	 ...
	 */
	protected HDFSBean getConfiguration() {
		return mHdfsConfiguration;
	}
	 ...
	 */
	protected void handleHDFSClientException(Exception e) throws IOException {

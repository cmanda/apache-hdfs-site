pluginRegister.setPluginComponent(new HDFSPluginSite());

function HDFSPluginSite() {
  ...
  function save(siteData, callback) {
    alert("Site data: " + $('#hdfsHostName').val() + ": " + $('#hdfsPort').val());
    console.log("Site data: " + siteData);
    if (siteData) {
      var customProperties = {
        		"hdfsHostName": $('#hdfsHostName').val(),
        		"hdfsPort": $('#hdfsPort').val(),
				"hdfsUrl": $('#hdfsUrl').val(),
				"hdfsUploadFolder": $('#hdfsUploadFolder').val(),
				"autoCreateDirectory": $('#autoCreateDirectory').val(),
				"hdfsDownloadFolder": $('#hdfsDownloadFolder').val(),
				"hdfsDownloadObjectKey": $('#hdfsDownloadObjectKey').val(),
